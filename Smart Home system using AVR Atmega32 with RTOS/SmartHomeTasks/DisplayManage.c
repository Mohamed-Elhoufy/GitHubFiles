...
{
	u8 Display_flag=DISPLAY_NOT_MAIN;
	LCD_ClearScreen();
	switch (state)
	{
		case SS_PW_CHECK:
		...
		UART_SendString("\r\n");
		UART_SendString(DISP_PW_CHECK_L0);
		UART_SendString("\r\n--------------------\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
		
		case SS_PW_MISS:
		LCD_WriteStringXY(1,0,DISP_PW_MISS_L0);
		UART_SendString("\r\n");
		UART_SendString(DISP_PW_MISS_L0);
		UART_SendString("\r\n--------------------\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
		...
		UART_SendString("\r\n");
		UART_SendString(DISP_LOCK_STUCK_L0);
		UART_SendString("\r\n");
		LCD_WriteStringXY(1,0,DISP_LOCK_STUCK_L1);
		UART_SendString(DISP_LOCK_STUCK_L1);
		UART_SendString("\r\n");
		LCD_WriteStringXY(3,0,DISP_LOCK_STUCK_L3);
		UART_SendString(DISP_LOCK_STUCK_L3);
		UART_SendString("\r\n--------------------\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
		
		case SS_MAIN:
        if (Display_flag==DISPLAY_NOT_MAIN)
        {
	        ...
	        Display_flag=DISPLAY_MAIN;
        }
		UART_SendString("\r\nCT:");
		UART_SendNum(SHApp.CTemp);
		UART_SendString(" AC:");
		UART_SendNum(SHApp.ACTemp);
		UART_SendString(" LI:");
		if(SHApp.Light_Mode=='M')
		{
			UART_SendNum(SHApp.Light_Intensity);
		}
		else if(SHApp.Light_Mode=='A')
		{
			UART_SendNum(SHApp.Ldr_Intensity);
		}
		UART_SendString("%\r\n");
		UART_SendString("  AS:");
		UART_Send(SHApp.Alarm_Status);
		UART_SendString("    LM:");
		UART_Send(SHApp.Light_Mode);
		UART_SendString("    \r\n");
		UART_SendString(DISP_MAIN_L2);
		UART_SendString("\r\n");
		UART_SendString(DISP_MAIN_L3);
		UART_SendString("\r\n");
		UART_SendString("\r\n--------------------\r\n");
		break;
		...
		UART_SendString("\r\n");
		UART_SendString(DISP_LIGHT_INT_L1);
		UART_SendString("\r\n");
		LCD_WriteStringXY(2,0,DISP_CONFIRM_L2);
		UART_SendString(DISP_CONFIRM_L2);
		UART_SendString("\r\n--------------------\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
		...
		UART_SendString("\r\n");
		UART_SendString(DISP_ACTEMP_L1);
		UART_SendString("\r\n");
		LCD_WriteStringXY(2,0,DISP_CONFIRM_L2);
		UART_SendString(DISP_CONFIRM_L2);
		UART_SendString("\r\n--------------------\r\n");
		...
		UART_SendString(DISP_PW_NEW_L0);
		UART_SendString("\r\n");
		LCD_WriteStringXY(3,0,DISP_PW_NEW_L3);
		UART_SendString(DISP_PW_NEW_L3);
		UART_SendString("\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
		...
		UART_SendString(DISP_ALARM_L1);
		UART_SendString("\r\n");
		LCD_WriteStringXY(2,0,DISP_ALARM_L2);
		UART_SendString(DISP_ALARM_L2);
		UART_SendString("\r\n");
		Display_flag=DISPLAY_NOT_MAIN;
		break;
	}
