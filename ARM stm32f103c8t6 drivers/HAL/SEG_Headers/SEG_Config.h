...
#define 		MUL_SEGMENT					1


/* SEG1 Connected pins / Multiplexed 2 segments  */
#define			SEG1_MUX_LED_A 		PINA2
#define			SEG1_MUX_LED_B 		PINA3
#define			SEG1_MUX_LED_C 		PINA4
#define			SEG1_MUX_LED_D 		PINA5
#define			SEG1_MUX_LED_E 		PINA6
#define			SEG1_MUX_LED_F 		PINA7
#define			SEG1_MUX_LED_G 		PINA8
#define			SEG1_MUX_EN 		PINA9
#define			SEG2_MUX_EN 		PINB0
