...
#if 	(SEGMENT_COMMON==CATHODE && TWO_SEGMENT==0 && MUL_SEGMENT==0)
...
#elif	(SEGMENT_COMMON==ANODE && TWO_SEGMENT==0 && MUL_SEGMENT==0)
void SEG_voidDisplay_D(u8 Copy_u8_dispNum)
{
	u8 Local_u8_bit=0;
	DIO_WritePin( SEG1_MUX_LED_A, ~GET_BIT(SegNumbers[Copy_u8_dispNum],Local_u8_bit++));
...
#elif	(SEGMENT_COMMON==CATHODE && TWO_SEGMENT==1 && MUL_SEGMENT==0)
void SEG_voidDisplay_D(u8 Copy_u8_dispNum)
{
	u8 Local_u8_bit=0;
...
#elif	(SEGMENT_COMMON==ANODE && TWO_SEGMENT==1 && MUL_SEGMENT==0)
...
#elif	(SEGMENT_COMMON==CATHODE && TWO_SEGMENT==1 && MUL_SEGMENT==1)
...
#elif	(SEGMENT_COMMON==ANODE && TWO_SEGMENT==1 && MUL_SEGMENT==1)
